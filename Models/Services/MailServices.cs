...
namespace Models.Services
{
    ...
    {
        private static readonly string _from = "nguyenkiman510@gmail.com"; // Email của Sender (của bạn)
        private static readonly string _pass = "Nguyenthimai1806))"; // Mật khẩu Email của Sender (của bạn)
